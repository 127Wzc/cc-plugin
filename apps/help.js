        ...
        const helpGroup = [
            // ===== 基础命令 =====
            {
                ...
                list: [
                    ...
                    { title: '#手办化 昵称', desc: '手动指定昵称（用于含 {{nickname}} 的预设）' },
                    { title: '#手办化 @用户 昵称', desc: '指定目标用户和昵称；也支持 QQ号 昵称' },
                    { title: '#手办化 -p 追加要求', desc: '在预设提示词后追加自定义要求' },
                    { title: '#预设 手办化', desc: '动态预设入口，锅巴新增后无需重启' },
